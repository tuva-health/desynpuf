...
,   to_date(clm_admsn_dt,'YYYYMMDD') as clm_admsn_dt
,   cast(admtng_icd9_dgns_cd as string) as admtng_icd9_dgns_cd
,   cast(clm_pass_thru_per_diem_amt as number) as clm_pass_thru_per_diem_amt
,   cast(nch_bene_ip_ddctbl_amt as number) as nch_bene_ip_ddctbl_amt
,   cast(nch_bene_pta_coinsrnc_lblty_am as number) as nch_bene_pta_coinsrnc_lblty_am
,   cast(nch_bene_blood_ddctbl_lblty_am as number) as nch_bene_blood_ddctbl_lblty_am
,   cast(clm_utlztn_day_cnt as int) as clm_utlztn_day_cnt
,   to_date(nch_bene_dschrg_dt,'YYYYMMDD') as nch_bene_dschrg_dt
,   cast(clm_drg_cd as string) as clm_drg_cd
